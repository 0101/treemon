...
a plain embedded PowerShell terminal. The terminal pane's **New** action and Ctrl+N from its active
terminal always start and focus another one for that worktree.
