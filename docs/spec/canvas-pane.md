...
- Worktree cards show yellow canvas notifications for new or updated docs. Notifications expire after 24 hours, deduplicate by filename, replace `LastUserMessage` while present, and click through to the relevant worktree or doc.
