...
- Worktree cards show yellow canvas notifications for new or updated docs. Notifications expire after
  24 hours, deduplicate by filename, replace the activity and last-user footer lines while present,
  remain visible alongside the dedicated last-assistant line, and click through to the relevant
  worktree or doc.
