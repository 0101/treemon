...
/* View */
.view { display: block; padding: 1.5rem 2rem 3rem; }

/* Issue badges (shared by issues table) */
.issue-priority {
...
<script>
// ─── Data Loading ────────────────────────────────────────────────────────────
// Fetches beads data from same-origin endpoint and renders the issues table.
